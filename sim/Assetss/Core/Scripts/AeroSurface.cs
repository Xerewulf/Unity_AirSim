...
public class AeroSurface : MonoBehaviour
{
    ...
    public BiVector3 CalculateForces(Vector3 worldAirVelocity, float airDensity, Vector3 relativePosition)
    {
        ...
        return forceAndTorque;//return force and torque as one bivector
    }

    private Vector3 CalculateCoefficients(float angleOfAttack)//mostly drag and lift force   && call by calcute forces.
    {
